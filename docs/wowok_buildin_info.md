  ...
  "result": {
    ...
    "data": {
      "result": [
        ...
        {"index": 317, "name": "service.setting_lock_duration_add", "description": "Add lock duration (ms) to service compensation fund — only-increase, affects withdraw waiting time", "object_type": "Service"},
